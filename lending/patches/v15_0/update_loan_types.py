...
def execute():
	for loan_type in frappe.db.get_all("Loan Type", fields=["name", "payment_account", "loan_account", "interest_income_account"]):
		frappe.db.set_value("Loan Type", loan_type.name, {
