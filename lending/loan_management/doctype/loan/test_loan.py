...
class TestLoan(LendingTestSuite):
	...
	def test_loan_gl_consolidation(self):
		...
		frappe.db.set_value(
			"Company",
			"_Test Company",
			{"loan_gl_consolidation": 1, "loan_gl_consolidation_start_date": "2025-04-01"}, update_modified=False
		)
		...
		loan = create_loan(
			...
			"Repay Over Number of Periods",
			6,
			repayment_start_date="2025-04-05",
			posting_date="2025-03-25",
			rate_of_interest=10,
			applicant_type="Customer",
		...
		disbursement = make_loan_disbursement_entry(
			loan.name, loan.loan_amount, disbursement_date="2025-03-25", repayment_start_date="2025-04-05"
		)

		date = ["2025-04-05", "2025-05-05", "2025-06-05", "2025-07-05", "2025-08-05", "2025-09-05"]
		for d in date:
