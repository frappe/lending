...
class TestLoanRestructure(IntegrationTestCase):
	...
	def test_loan_restructure_capitalization(self):
		...
		self.assertEqual(len(repayments), 6) # It will become 7 after the principal adjustment repayment is added (PR: #1060)
...
def create_loan_restructure(
	...
	return doc
>>>>>>> 7bf59d6f (fix: correct GL entries for unaccrued interest capitalization)
